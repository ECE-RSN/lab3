...
if [ $# -eq 0 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  ./grade.sh ~/Desktop/lab3/lab3_ws"
...
echo "============================================================"
echo "Lab 3 Autograder"
echo "============================================================"
echo "Student workspace: $STUDENT_WS_ABS"
echo ""

# Check if custom image exists, build if needed
if $DOCKER_CMD image inspect lab3-grader >/dev/null 2>&1; then
    echo "✓ Using existing lab3-grader image"
    IMAGE="lab3-grader"
    INSTALL_CMD=""
else
    echo "lab3-grader image not found"
    
    # Check if Dockerfile exists
    if [ -f "$SCRIPT_DIR/Dockerfile" ]; then
        echo "Building lab3-grader image..."
        echo ""
        
        $DOCKER_CMD build -t lab3-grader "$SCRIPT_DIR"
